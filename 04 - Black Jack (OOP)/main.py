...
# Where the key is the card rank and the value is the numerical value of the
# card.
VALUES = {
    "2": 2,
    "3": 3,
...
class Card:
    ...
    def __init__(self, rank, suit):
        """
        Upon instantiation, a card object is assigned with a display
...
class Deck:
    ...
    def __init__(self):
        """
        Upon instantiation, a deck object is assigned with an all_cards
        attribute.

        Where all_cards consists of 52 card objects.
        The 52 card objects are the result of a nested for loop of
        VALUES and SUITS.
        """
        self.all_cards = []
        for rank in VALUES:
    ...
    def deal_card(self):
        """
        Method that removes a single card object from the deck by
        popping a card from the all_cards attribute.
...
class Player:
    ...
    def __init__(self, player_name, player_bankroll):
        """
        Upon instantiation a player object is assigned a name, a
        bankroll, and a hand attribute.
    ...
    def display_full_hand(self):
        """
        Method that displays a visual representation of the card objects
        in a player's hand.

        It does so by appending the display attribute of a card object
        to full_hand.
    ...
    def display_partial_hand(self):
        """
        Method that displays a partial visual representation of the card
        objects in a player's hand.
        It does so by appending the display attribute of the card
        object's in 'self.hand' from index 1 onwards.
    ...
    def hand_value(self):
        ...
        It does so by adding up the value attributes of the card objects
        in a player's hand.
        If player's hand value is over 21, and they have aces in their
        hand.
        The player's hand value is reduced by 10 for every ace in their
        hand.
    ...
    def clear_hand(self):
        """
        Method that clears a player object's hand attribute and removes
    ...
    def collect(self, winnings):
        """
        Method that collect a player's winnings after winning a round
        and updates their bankroll attribute.
    ...
    def __str__(self):
        ...
        """
        return (
            f"{self.name} has {len(self.hand)} cards in hand.\n"
...
def hit_or_stick():
    ...
    while True:
        play = input(
            "Would you like a 'Hit' or do you want to 'Stick': "
        ).lower()
        if play == "hit":
            return True
        elif play == "stick":
...
while replay:
    ...
    if p1.hand_value() == 21:
        ...
        game_over = True
    # If player does not have Black Jack start game_over while loop to
    # control game flow.
    while not game_over:
        ...
        # Else player wants to 'Stick'.
            ...
            while dealer.hand_value() < 17:
                ...
                print(
                    f"{dealer.name} has a hand value of less than 17.  Extra "
                    f"card issued."
                )
