...
class Card:
    ...
    def __init__(self, suit, rank):
        """
        Upon instantiation Card object attributes suit, face, and value
        are created.
        """
        self.suit = suit
        self.rank = rank
    ...
    def __str__(self):
        """
        Returns a string that represents the Card object for the print
        function.
        """
...
class Deck:
    ...
    def __init__(self):
        """
        Upon instantiation of a Deck object 52 Card objects are created
        and appended to attribute all_cards.
        """
        self.all_cards = []
        for suit in SUITS:
            for rank in RANKS:
    ...
    def deal_card(self):
        """
        Method that simulates removing a single Card object from the top
        of the deck object by popping a card object from self.all_cards.
        """
...
class Player:
    ...
    def __init__(self, name):
        """
        Upon instantiation the Player object is assigned a name
        attribute and all_cards attribute. Where all_cards is an empty
        list.
        """
        self.name = name
        self.all_cards = []
    ...
    def play_card(self):
        """
        Method that simulates removing a single Card object from the top
        of the Player object's all_cards by popping a card object from
        self.all_cards.
        """
    ...
    def pick_up_card(self, pick_up):
        """
        Method that simulates picking up Card objects and placing at the
        bottom of a Player object's all_cards. If the card object to
        pick up is a list with multiple values, the .extend() method
        will be used. If the card object is a single item, the .append()
        method will be used.
        """
...
# Create while loop that ends game when whole deck acquired by either player.
game_over = False
while not game_over:
    ...
    print(
        f"Player 1 played the {player_1_played_card.rank} of "
        f"{player_1_played_card.suit}."
    )
    print(
        f"Player 2 played the {player_2_played_card.rank} of "
        f"{player_2_played_card.suit}."
    )
    ...
    # Else if both players played a card of equal value.
        ...
        while war:
            ...
            if len(player_1.all_cards) < stake_cards + 1:
                ...
                cards_played = []
                # Have player_2 pick up previous war_cards if any.
            ...
            # Else
                ...
                # Each player play additional card and append to played cards.
                player_1_played_card = player_1.play_card()
                cards_played.append(player_1_played_card)
                player_2_played_card = player_2.play_card()
                cards_played.append(player_2_played_card)
    ...
    # To avoid cards syncing and generating no winner.
    if counter > 500:
